...
namespace DataAccess.Migrations
{
    ...
    [Migration("20231119131216_UseAzureDb")]
    partial class UseAzureDb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccess.Data.Entities.UserSubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataAccess.Data.Entities.UserSubscription", b =>
                {
                    b.HasOne("DataAccess.Data.Entities.User", "SubscribedTo")
                        .WithMany("Subscriptions")
                        .HasForeignKey("SubscribedToId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("DataAccess.Data.Entities.User", "Subscriber")
